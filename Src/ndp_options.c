...
ndp_optPayload *ndp_createOptionRouteInformation(const uint8_t prefixLength, uint8_t routePreference, const uint32_t routeLifetime, struct in6_addr prefix)
{
